function fish_prompt --description 'Write out the prompt'
    ...
    echo -n -s \n \
      (prompt_jobs) (prompt_state) (set -q SSH_TTY && prompt_login) ' ' (set_color $color_cwd) (prompt_pwd) $normal (string match -qr '^/media/sshfs/' $PWD || fish_vcs_prompt) $normal $prompt_status \n \
      $suffix ' '
end
